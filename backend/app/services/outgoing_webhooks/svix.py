...
def list_endpoints(app_id: str, options: EndpointListOptions | None = None) -> ListResponseEndpointOut:
    assert _client is not None
    return _client.endpoint.list(app_id, options or EndpointListOptions())
